...
export const CatGalleryFetch = () => {
  ...
  return (
    <div className='container mt-5'>
      ...
      {/* Contenedor con scroll vertical y altura fija */}
      <div className='row overflow-auto' style={{ maxHeight: '80vh', overflowY: 'scroll' }}>
        {cats.map((cat, index) => (
          <div className='col-md-4 mb-4' key={index}>
            <div className='card h-100 d-flex flex-column'>
              {/* Ajustar la imagen para que tenga un tamaño consistente */}
              <img 
                src={cat.url} 
